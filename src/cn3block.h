...
protected:
  [[nodiscard]] size_t
  BitCount() const override; ///< Returns number of bits in value.
  [[nodiscard]] size_t
  BitOffset() const override; ///< Returns bit offset (0..7).
  [[nodiscard]] size_t
  ByteOffset() const override; ///< Returns byte offset in record.
